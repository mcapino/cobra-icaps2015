...
public class SuperconflictCreator extends DCSPCreator {
    ...
    final int NO_OF_AIRPLANES = 12;
    final double CIRCLE_RADIUS = 5;
    final Point CENTER = new Point(5,5,0);
    ...
    protected Parameters configureParameters(Parameters params) {
        ...
        params.SPEED = 1.0;
        params.MAX_T = (int)(params.MAX_X*2/ (params.SPEED));
    ...
    protected List<Agent> createAgents() {
        ...
        for (int i=0; i < NO_OF_AIRPLANES; i++) {
            ...
            agents.add(new InterruptibleAsynchronousPrioritizedPlanningAgent("A"
