...
public class ExperimentCreator implements Creator {

    private Parameters params = new Parameters();
    Logger LOGGER = Logger.getLogger(ExperimentCreator.class);
    ...
    public void create() {
        ...
        int FIRST_SEED = 19;
        int NSEEDS = 20;
        Graph<Waypoint, SpatialManeuver> maneuvers = new FourWayConstantSpeedGridGraph(
            ...
            for (int nAgents = MIN_AGENTS; nAgents <= MAX_AGENTS; nAgents += STEP) {
                ...
                for (int seed = FIRST_SEED; seed < FIRST_SEED+NSEEDS; seed++) {
                    try {
                        ...
                        Mission[] agentMissions = GraphAgentMissionGenerator
                        ...
                        /*
                         ...
                         AgentMissionGenerator.generateSpiralSuperconflict(maneuvers, nAgents, new Point(10,10,0),
                         2.0, 6.0, 0);*/
